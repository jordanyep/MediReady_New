...
public class Tab1_PersonFragment extends Fragment{
    private static final String TAG = "Tab1_PersonFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_persondetail1,container,false);
